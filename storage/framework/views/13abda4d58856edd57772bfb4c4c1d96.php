...
<div class="container mt-2">
    <div class="text-sm">
        <span style="margin-left: 17px;">Categories - <?php echo e($category->id); ?> - Edit</span>
...
<div class="container mt-2">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <?php echo Form::model($category,['url' => $category->getEditPostLink()]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\auto-diely\resources\views/categories/edit.blade.php ENDPATH**/ ?>